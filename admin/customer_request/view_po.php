...
<div class="card card-outline card-info">
	<div class="card-header">
        ...
        <div class="card-tools">
		    ...
		    <a class="btn btn-sm btn-flat btn-primary" href="?page=customer_request/manage_po&id=<?php echo $id ?>">Edit</a>
		    <a class="btn btn-sm btn-flat btn-default" href="?page=customer_request">Back</a>
        </div>
	</div>
	<div class="card-body" id="out_print">
        ...
        <div class="col-6">
            ...
            <h2 class="text-center"><b>CUSTOMER REQUEST</b></h2>
        </div>
        </div>
        <div class="row mb-2">
            <div class="col-6">
                <p class="m-0"><b>Vendor Comes from Supplier List, change to authorities</b></p>
                <?php 
